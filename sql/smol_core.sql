...
-- ============================================================================
-- smol_build (moved from standalone file - build and growth tests)
-- ============================================================================
-- Consolidates: build_edges, growth, large_row_warning
SET client_min_messages = warning;
CREATE EXTENSION IF NOT EXISTS smol;
...
-- ============================================================================
-- smol_16byte_include (minimal test for 16-byte INCLUDE coverage)
-- ============================================================================
-- Test MACADDR8 in INCLUDE to cover smol_scan.c:223 (16-byte INCLUDE copy)
...
-- Cleanup
DROP TABLE t_macaddr8_inc CASCADE;
