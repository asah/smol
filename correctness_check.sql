-- Correctness check: compare BTREE vs SMOL query results on the same data
-- Defaults: 5M SMALLINT rows, 2.5M INT4 rows
\if :{?rows_si}
\else
\set rows_si 5000000
\endif
...
SET max_parallel_workers_per_gather = 0;  -- enforce uniprocessor for correctness
